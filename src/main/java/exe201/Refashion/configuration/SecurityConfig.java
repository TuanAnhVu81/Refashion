...
public class SecurityConfig {
    ...
    private final String[] PUBLIC_ENDPOINT = {"/users", "/auth/token", "/auth/introspect", "/auth/google/login",
            "/users/verify-email"};
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5174")); // Cho phép frontend truy cập
